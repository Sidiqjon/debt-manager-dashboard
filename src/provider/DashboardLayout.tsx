...
//       // "Asosiy" should be active for both "/" and "/calendar" since calendar is nested under Asosiy
...
//                 <img src={location.pathname === item.key ? item.activeIcon : item.icon} alt={item.label} className="w-full h-full cursor-pointer" />
//               </div>
